...
def button_choice(img_address1, img_address2, con: float = 0.8, fre: float = 0.5):
    while (True):
        button_pos1 = pyautogui.locateCenterOnScreen(
            img_address1, confidence=con)
        button_pos2 = pyautogui.locateCenterOnScreen(
            img_address2, confidence=con)
...
def kun28():
    ...
    for i in range(1, N+1):
        ...
        p_start = pyautogui.locateCenterOnScreen(
            'tansuokaishi.png', confidence=0.7)
        if p_start is None and p_new is not None:
            pyautogui.click(p_new[0]+random.randint(-20, 20),
                            p_new[1]+random.randint(0, 15))
        p_start = button('tansuokaishi.png')
        # time.sleep(3)
        # p_start=pyautogui.locateCenterOnScreen('tansuokaishi.png',confidence=0.8)
        pyautogui.click(p_start[0]+random.randint(-20, 20),
                        p_start[1]+random.randint(0, 10))
        time.sleep(1)
        p_end = pyautogui.locateCenterOnScreen(
            'tansuojieshu.png', confidence=0.7)
        while p_end is None:
            ...
            if p_ts is not None:
                ...
                time.sleep(1.5)
                p_end = pyautogui.locateCenterOnScreen(
                    'tansuojieshu.png', confidence=0.8)
        ...
        pyautogui.click()
        time.sleep(5)
        p_zhanlipin = pyautogui.locateCenterOnScreen(
            'zhanlipin.png', confidence=0.8)
        # print(p_zhanlipin)
...
def jiejietupo():
    ...
    for i in range(1, N+1):
        ...
        # time.sleep(1)
        # pyautogui.click()
        pyautogui.moveTo(p_vic[0]+random.randint(-50, 50), p_vic[1] +
                         random.randint(-50, 50), random.uniform(0.5, 0.8))
        time.sleep(0.5)
        pyautogui.click()

        time.sleep(2)
        p_another = pyautogui.locateCenterOnScreen(
            'jiesuan.png', confidence=0.7)
...
def zudui11():
    ...
    for i in range(1, N+1):
        ...
        pyautogui.moveTo(p_victory1[0]+random.randint(-30, 30),
                         p_victory1[1]+random.randint(-30, 30), mouse[0], mouse[1])
        pyautogui.click()
        time.sleep(1.5)
        pyautogui.moveTo(2000+random.randint(-100, 100),
                         380+random.randint(-10, 10, 0.5))
        p_vic2 = button('victory.png')
        pyautogui.moveTo(p_vic2[0]+random.randint(-30, 30),
                         p_vic2[1]+random.randint(-30, 30), mouse[0], mouse[1])
        pyautogui.click()

        p_js1 = button('jiesuan.png')
        pyautogui.moveTo(p_js1[0]+random.randint(-30, 30),
                         p_js1[1]+random.randint(-30, 30), mouse[0], mouse[1])
        pyautogui.click()

        p_js2 = button('jiesuan.png')
        pyautogui.moveTo(p_js2[0]+random.randint(-30, 30),
                         p_js2[1]+random.randint(-30, 30), mouse[0], mouse[1])
        pyautogui.click()
...
def yeyuanhuo():
    ...
    for i in range(1, N+1):
        ...
        pyautogui.moveTo(p_vic[0]+random.randint(-30, 30),
                         p_vic[1]+random.randint(-10, 10), mouse[0], mouse[1])
        pyautogui.click()
        p_js = button('jiesuan.png')
        pyautogui.moveTo(p_js[0]+random.randint(-30, 30),
                         p_js[1]+random.randint(-30, 30), mouse[0], mouse[1])
        pyautogui.click()
...
def daixinghuodong():
    ...
    for i in range(1, N+1):
        ...
        pyautogui.click()
        # p_vic2 = button('victory.png')
        # pyautogui.moveTo(p_vic2[0]+random.randint(-300, -100),
        #                  p_vic2[1]+random.randint(50, 300), mouse[0], mouse[1])
        pyautogui.click()
# 主函数
